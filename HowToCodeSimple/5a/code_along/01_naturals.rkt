...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 01_naturals) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; 
...
(: sum (Natural -> Natural))
;; Produce the sum of all naturals in [0, n].
...
;; Produce a list of all naturals from n down to 1 in order.
