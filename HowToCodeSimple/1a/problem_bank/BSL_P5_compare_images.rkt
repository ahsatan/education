...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname BSL_P5_compare_images) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; 
; PROBLEM
; 
