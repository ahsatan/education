...
val test8 = all_same_color [(Hearts, Ace), (Hearts, Queen)] = true
...
val test12 = score_challenge([(Clubs,Ace)], 11)                                = 0
...
val test14 = careful_player ([(Hearts,Ace),(Spades,Ace),(Clubs,Ace),(Spades,Ace)], 11) = [Draw]
